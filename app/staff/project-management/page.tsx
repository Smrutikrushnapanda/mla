            ...
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="mt-1">
                    <Badge variant="outline" className="font-mono" style={{ borderColor: theme.cardBorder, color: theme.textPrimary }}>
                      {selectedProject.id}
                    </Badge>
                  </p>
                </div>
                <div>
                  ...
                  <p className="mt-1">
                    <Badge style={{
                      backgroundColor: selectedProject.status === "Completed" ? "#22c55e" : selectedProject.status === "In Progress" ? "#3b82f6" : selectedProject.status === "On Hold" ? "#f59e0b" : "#6b7280",
                      color: "#ffffff",
                    }}>
              ...
              <div className="p-4 rounded-md border" style={{ borderColor: theme.border, backgroundColor: theme.backgroundSecondary }}>
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 font-medium" style={{ color: theme.textPrimary }}>
                      {formatCurrency(selectedProject.sanctionedBudget)}
                    </p>
                  </div>
                  <div>
                    <Label className="text-xs" style={{ color: theme.textSecondary }}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="mt-1 font-medium" style={{ color: theme.textPrimary }}>
                    {new Date(selectedProject.startDate).toLocaleDateString("en-IN", { day: "2-digit", month: "short", year: "numeric" })}
                  </p>
                </div>
                <div>
                  <Label className="text-sm font-medium" style={{ color: theme.textSecondary }}>
                  ...
                  <p className="mt-1 font-medium" style={{ color: theme.textPrimary }}>
                    {new Date(selectedProject.expectedEndDate).toLocaleDateString("en-IN", { day: "2-digit", month: "short", year: "numeric" })}
                  </p>
                </div>
              </div>
                ...
                <div className="mt-2 flex items-center gap-3">
                  <div className="flex-1 h-3 rounded-full overflow-hidden" style={{ backgroundColor: "#e5e7eb" }}>
                    <div className="h-full rounded-full transition-all" style={{ 
                      ...
                      backgroundColor: selectedProject.progress === 100 ? "#22c55e" : selectedProject.progress >= 50 ? "#3b82f6" : "#f59e0b"
                    }} />
                  </div>
              ...
              <div>
                ...
                <p className="mt-1">
                  <Badge style={{
                    backgroundColor: selectedProject.priority === "Critical" ? "#dc2626" : selectedProject.priority === "High" ? "#ef4444" : selectedProject.priority === "Medium" ? "#f59e0b" : "#10b981",
                    color: "#ffffff",
                  }}>
