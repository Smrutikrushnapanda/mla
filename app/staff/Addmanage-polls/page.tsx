...
export default function AddPollPage() {
      ...
      if (option.trim()) {
        ...
        if (
          filledOptions.filter(
            (opt) => opt.trim().toLowerCase() === trimmedOption
          ).length > 1
        ) {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push("/mla-dashboard/manage-polls");
    } catch (error) {
    ...
    <div className="space-y-6">
      ...
      <form onSubmit={onSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("pollTitle", e.target.value)
                  }
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  >
                    <SelectItem value="Local Development">
                      Local Development
                    </SelectItem>
                    <SelectItem value="Government Schemes">
                      Government Schemes
                    </SelectItem>
                    <SelectItem value="Public Services">
                      Public Services
                    </SelectItem>
                    <SelectItem value="Legislative Issues">
                      Legislative Issues
                    </SelectItem>
                    ...
                    <SelectItem value="Women & Child Welfare">
                      Women & Child Welfare
                    </SelectItem>
                    <SelectItem value="Environment & Sanitation">
                      Environment & Sanitation
                    </SelectItem>
                    <SelectItem value="Employment & Livelihood">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleInputChange("pollType", value)
                  }
                >
                  <SelectTrigger
                    style={{
                ...
                <div className="flex-1 space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      style={{
                        backgroundColor: theme.backgroundSecondary,
                        borderColor: errors[`option${index}`]
                          ? "#ef4444"
                          : theme.border,
                        color: theme.textPrimary,
                      }}
                ...
                >
                  ...
                  >
                    ...
                    <SelectItem value="Scheduled">
                      Scheduled (Publish on start date)
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
        ...
        <div className="flex justify-end gap-3">
          <Link href="/mla-dashboard/manage-polls">
            <Button
              type="button"
              variant="outline"
              style={{
