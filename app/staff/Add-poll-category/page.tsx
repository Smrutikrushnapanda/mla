// app/(protected)/staff/Add-poll-category/page.tsx
"use client"
...
export default function AddPollCategoryPage() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Poll Category data:", formData)
      toast.success("Poll category added successfully!")
      router.push("/staff/poll-category")
    } catch (error) {
      toast.error("Failed to add poll category")
    } finally {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          >
            Create a new poll category for citizen engagement
          </p>
        </div>
        
        <Link href="/staff/poll-category">
          <Button
        ...
        >
          <CardHeader>
            ...
            <CardDescription style={{ color: theme.textSecondary }}>
              Enter the poll category information
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Describe the purpose and scope of this poll category..."
                rows={4}
                style={{
                  backgroundColor: theme.input.bg,
