// app/(roles)/admin-user/my-voice/components/AllQuestionsTab.tsx
"use client";
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        <p
          className="text-sm"
          style={{
            color: theme.textTertiary || (darkMode ? "#94a3b8" : "#64748b"),
          }}
        >
        ...
        {currentQuestions.length > 0 ? (
          ...
          >
            <MessageSquare
              ...
              style={{
                color: theme.textTertiary || (darkMode ? "#475569" : "#94a3b8"),
              }}
            />
            <h3
