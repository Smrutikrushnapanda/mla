// components/mla-dashboard/public-voice/all-questions/table/data-table.tsx
"use client"
...
export function DataTable<TData, TValue>({
  ...
  const [sorting, setSorting] = React.useState<SortingState>([
    { id: "votes", desc: true } // Default sort by votes (highest first)
  ])
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-4 flex-wrap">
        ...
        <Select
          ...
          onValueChange={(value) =>
            table.getColumn("format")?.setFilterValue(value === "all" ? "" : value)
          }
        >
          <SelectTrigger 
            className="w-[180px]"
      ...
      <div className="flex items-center justify-between">
        <div 
          ...
          style={{ color: theme.textSecondary }}
        >
          Showing {table.getFilteredRowModel().rows.length} of {data.length} questions
        </div>
